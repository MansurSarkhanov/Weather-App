...
import 'package:weather_app/Feature/Presentation/Screens/home_page.dart';
                ...
                child: Stack(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: InkWell(
                          onTap: () {
                            onboardingProviderRead.nextPage(context);
                          },
                          child: Container(
                            height: 60,
                            width: 60,
                    ...
                    children: [
                      Expanded(
                        ...
                        child: Container(
                          ...
                          child: Align(
                              alignment: Alignment.bottomCenter, child: Image.asset(onboardingModel[index].image)),
                        ),
                      ),
                      Expanded(
                        flex: 5,
